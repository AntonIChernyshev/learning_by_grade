  ...
  return (
    <Layout>
      <div className="max-w-4xl mx-auto">
        <h1 className="text-center">Science Exercises</h1>
        
        <div className="card mb-8">
          <p className="text-lg mb-4">
            Welcome to the Science section! Here you can learn about the world around you with fun and interactive exercises.
          </p>
          ...
          <button
            ...
            disabled={isLoading}
          >
            {isLoading ? 'Generating...' : 'Generate New Science Exercise'}
          </button>
        </div>
        
        {exercise && (
          <div className="card mb-8">
            <h2 className="text-2xl mb-4 text-center">Your Science Exercise</h2>
        ...
        <div className="card bg-primary-50">
          <h2 className="text-xl mb-4">Science Topics for 2nd Grade</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>Plants and how they grow</li>
            <li>Animals and their habitats</li>
            <li>Weather and seasons</li>
            <li>States of matter (solid, liquid, gas)</li>
            <li>The solar system and planets</li>
            <li>Simple machines and how they work</li>
          </ul>
        </div>
      </div>
    </Layout>
